...
public class DetectCycleInUndirectedGraphUsingDFS {
    ...
    private static boolean dfsCycle(final List<List<Integer>> adj,
        ...
        for (Integer neighbour : adj.get(source)) {
            ...
            boolean hasCycle = dfsCycle(adj, neighbour, visited, parent);
            if (hasCycle) {
                return true;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Test case 1 (Graph with self-loop): " +
                DetectCycleInUndirectedGraphUsingDFS.hasCycle(graph1.getNumberOfVertices(), graph1.getAdj()));
        ...
        System.out.println("Test case 2 (Graph with no cycle): " +
                DetectCycleInUndirectedGraphUsingDFS.hasCycle(graph2.getNumberOfVertices(), graph2.getAdj()));
        ...
        System.out.println("Test case 3 (Graph with a cycle): " +
                DetectCycleInUndirectedGraphUsingDFS.hasCycle(graph3.getNumberOfVertices(), graph3.getAdj()));
        ...
        System.out.println("Test case 4 (Disconnected graph with a cycle): " +
                DetectCycleInUndirectedGraphUsingDFS.hasCycle(graph4.getNumberOfVertices(), graph4.getAdj()));
        ...
        System.out.println("Test case 5 (Empty graph): " +
                DetectCycleInUndirectedGraphUsingDFS.hasCycle(graph5.getNumberOfVertices(), graph5.getAdj()));
        ...
        System.out.println("Test case 6 (Graph with multiple cycles): " +
                DetectCycleInUndirectedGraphUsingDFS.hasCycle(graph6.getNumberOfVertices(), graph6.getAdj()));
    }
